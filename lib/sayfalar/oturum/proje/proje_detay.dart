    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("Proje Detayı", style: GoogleFonts.quicksand(color: Colors.white, fontSize: 30)),
          centerTitle: true,
        ),
        body: Padding(
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      // uzun metinler için
                      AutoSizeText(widget.proje.projeBaslik!, style: GoogleFonts.quicksand(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),
                      textAlign: TextAlign.center,
                      maxLines: 2,),
                      SizedBox(width: 10,),
                      bilgiSatir("Başlangıç Tarihi", widget.proje.projeTeslimTarihi!),
                      bilgiSatir("Bitiş Tarihi", widget.proje.projeTeslimTarihi!),
                      ...
                      widget.proje.dosyaYolu!.isNotEmpty?InkWell(
                        onTap: () {
                          print("Dosya indi");
                        },
                        child: Container(
